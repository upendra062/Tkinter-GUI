...
# Heading
Label(root, text="Welcome to Upendra Travels", font="comicsansms 13 bold", pady=15).grid(row=0,column=3)
...
Button(text="Submit to Upendra Travels", command=getvals).grid(row=7, column=3)
